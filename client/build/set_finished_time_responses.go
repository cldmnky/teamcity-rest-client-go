...
func (o *SetFinishedTimeOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/builds/{buildLocator}/finishDate][%d] setFinishedTimeOK  %+v", 200, o.Payload)
}
...
func (o *SetFinishedTimeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

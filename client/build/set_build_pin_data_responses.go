...
func (o *SetBuildPinDataOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/builds/{buildLocator}/pinInfo][%d] setBuildPinDataOK  %+v", 200, o.Payload)
}
...
func (o *SetBuildPinDataOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

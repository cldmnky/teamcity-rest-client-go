...
func (o *SetVCSLabelingOptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSetVCSLabelingOptionsOK()
...
func NewSetVCSLabelingOptionsOK() *SetVCSLabelingOptionsOK {
	return &SetVCSLabelingOptionsOK{}
}
...
func (o *SetVCSLabelingOptionsOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/buildTypes/{btLocator}/vcsLabeling][%d] setVCSLabelingOptionsOK  %+v", 200, o.Payload)
}
...
func (o *SetVCSLabelingOptionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

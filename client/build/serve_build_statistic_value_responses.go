...
func (o *ServeBuildStatisticValueReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewServeBuildStatisticValueOK()
...
func NewServeBuildStatisticValueOK() *ServeBuildStatisticValueOK {
	return &ServeBuildStatisticValueOK{}
}
...
func (o *ServeBuildStatisticValueOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/builds/{buildLocator}/statistics/{name}][%d] serveBuildStatisticValueOK  %+v", 200, o.Payload)
}
...
func (o *ServeBuildStatisticValueOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *GetAliasesOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/buildTypes/{btLocator}/aliases][%d] getAliasesOK  %+v", 200, o.Payload)
}
...
func (o *GetAliasesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

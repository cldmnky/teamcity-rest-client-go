...
func (o *SetParameterTypeRawValueReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSetParameterTypeRawValueOK()
...
func NewSetParameterTypeRawValueOK() *SetParameterTypeRawValueOK {
	return &SetParameterTypeRawValueOK{}
}
...
func (o *SetParameterTypeRawValueOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/projects/{projectLocator}/parameters/{name}/type/rawValue][%d] setParameterTypeRawValueOK  %+v", 200, o.Payload)
}
...
func (o *SetParameterTypeRawValueOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

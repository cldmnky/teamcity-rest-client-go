...
func (o *GetTriggersOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/buildTypes/{btLocator}/triggers][%d] getTriggersOK  %+v", 200, o.Payload)
}
...
func (o *GetTriggersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

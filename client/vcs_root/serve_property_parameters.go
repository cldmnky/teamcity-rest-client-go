...
// NewServePropertyParams creates a new ServePropertyParams object
// with the default values initialized.
func NewServePropertyParams() *ServePropertyParams {
	var ()
	return &ServePropertyParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewServePropertyParamsWithTimeout creates a new ServePropertyParams object
...
// NewServePropertyParamsWithContext creates a new ServePropertyParams object
...
// NewServePropertyParamsWithHTTPClient creates a new ServePropertyParams object
...
/*ServePropertyParams contains all the parameters to send to the API endpoint
for the serve property operation typically these are written to a http.Request
*/
type ServePropertyParams struct {

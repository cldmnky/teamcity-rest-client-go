...
func (o *ServeInstancesOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/vcs-root-instances][%d] serveInstancesOK  %+v", 200, o.Payload)
}
...
func (o *ServeInstancesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

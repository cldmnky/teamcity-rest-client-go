...
func (o *InterruptThreadOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/debug/threads/{threadLocator}/interrupted][%d] interruptThreadOK  %+v", 200, o.Payload)
}
...
func (o *InterruptThreadOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *CancelMultipleOK) Error() string {
	return fmt.Sprintf("[POST /app/rest/builds/multiple/{buildLocator}][%d] cancelMultipleOK  %+v", 200, o.Payload)
}

func (o *CancelMultipleOK) GetPayload() *models.MultipleOperationResult {
	return o.Payload
}

func (o *CancelMultipleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

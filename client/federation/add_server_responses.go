...
func (o *AddServerOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/federation/servers][%d] addServerOK  %+v", 200, o.Payload)
}
...
func (o *AddServerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

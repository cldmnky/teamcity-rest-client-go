...
func (o *ServeBuildTypeFieldReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewServeBuildTypeFieldOK()
...
func (o *ServeBuildTypeFieldOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/buildTypes/{btLocator}/{field}][%d] serveBuildTypeFieldOK  %+v", 200, o.Payload)
}
...
func (o *ServeBuildTypeFieldOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

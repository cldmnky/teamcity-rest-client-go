...
func (o *ServeTemplatesInProjectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewServeTemplatesInProjectOK()
...
func NewServeTemplatesInProjectOK() *ServeTemplatesInProjectOK {
	return &ServeTemplatesInProjectOK{}
}
...
func (o *ServeTemplatesInProjectOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/projects/{projectLocator}/templates][%d] serveTemplatesInProjectOK  %+v", 200, o.Payload)
}
...
func (o *ServeTemplatesInProjectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

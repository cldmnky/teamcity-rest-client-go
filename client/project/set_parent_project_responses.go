...
func (o *SetParentProjectOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/projects/{projectLocator}/parentProject][%d] setParentProjectOK  %+v", 200, o.Payload)
}
...
func (o *SetParentProjectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

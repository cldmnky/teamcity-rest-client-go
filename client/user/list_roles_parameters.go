...
// WithUserLocator adds the userLocator to the list roles params
func (o *ListRolesParams) WithUserLocator(userLocator string) *ListRolesParams {
	o.SetUserLocator(userLocator)
	return o
}

// SetUserLocator adds the userLocator to the list roles params
func (o *ListRolesParams) SetUserLocator(userLocator string) {

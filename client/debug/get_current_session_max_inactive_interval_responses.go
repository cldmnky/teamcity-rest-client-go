...
func (o *GetCurrentSessionMaxInactiveIntervalReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCurrentSessionMaxInactiveIntervalOK()
...
func NewGetCurrentSessionMaxInactiveIntervalOK() *GetCurrentSessionMaxInactiveIntervalOK {
	return &GetCurrentSessionMaxInactiveIntervalOK{}
}
...
func (o *GetCurrentSessionMaxInactiveIntervalOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/debug/currentRequest/session/maxInactiveSeconds][%d] getCurrentSessionMaxInactiveIntervalOK  %+v", 200, o.Payload)
}
...
func (o *GetCurrentSessionMaxInactiveIntervalOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

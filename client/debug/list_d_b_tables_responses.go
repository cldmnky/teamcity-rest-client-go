...
func (o *ListDBTablesOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/debug/database/tables][%d] listDBTablesOK  %+v", 200, o.Payload)
}
...
func (o *ListDBTablesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

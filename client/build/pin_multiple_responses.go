...
func (o *PinMultipleOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/builds/multiple/{buildLocator}/pinInfo][%d] pinMultipleOK  %+v", 200, o.Payload)
}
...
func (o *PinMultipleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

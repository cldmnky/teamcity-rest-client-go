...
func (o *ServeGroupOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/userGroups/{groupLocator}][%d] serveGroupOK  %+v", 200, o.Payload)
}
...
func (o *ServeGroupOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *CancelBuildOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/builds/{buildLocator}/example/buildCancelRequest][%d] cancelBuildOK  %+v", 200, o.Payload)
}
...
func (o *CancelBuildOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.BuildCancelRequest)

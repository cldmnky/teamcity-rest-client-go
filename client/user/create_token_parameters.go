...
// WithFields adds the fields to the create token params
func (o *CreateTokenParams) WithFields(fields *string) *CreateTokenParams {
	o.SetFields(fields)
	return o
}

// SetFields adds the fields to the create token params
func (o *CreateTokenParams) SetFields(fields *string) {
	o.Fields = fields
}
...
// WithUserLocator adds the userLocator to the create token params
func (o *CreateTokenParams) WithUserLocator(userLocator string) *CreateTokenParams {
	o.SetUserLocator(userLocator)
	return o
}

// SetUserLocator adds the userLocator to the create token params
func (o *CreateTokenParams) SetUserLocator(userLocator string) {

...
func (o *GetMultipleOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/builds/multiple/{buildLocator}][%d] getMultipleOK  %+v", 200, o.Payload)
}
...
func (o *GetMultipleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

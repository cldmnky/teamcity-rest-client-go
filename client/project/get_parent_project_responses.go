...
func (o *GetParentProjectOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/projects/{projectLocator}/parentProject][%d] getParentProjectOK  %+v", 200, o.Payload)
}
...
func (o *GetParentProjectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

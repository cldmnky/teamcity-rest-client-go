...
func (o *PutParameterOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/vcs-roots/{vcsRootLocator}/properties/{name}][%d] putParameterOK  %+v", 200, o.Payload)
}
...
func (o *PutParameterOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

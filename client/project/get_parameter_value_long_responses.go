...
func (o *GetParameterValueLongReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetParameterValueLongOK()
...
func NewGetParameterValueLongOK() *GetParameterValueLongOK {
	return &GetParameterValueLongOK{}
}
...
func (o *GetParameterValueLongOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/projects/{projectLocator}/projectFeatures/{featureLocator}/properties/{name}/value][%d] getParameterValueLongOK  %+v", 200, o.Payload)
}
...
func (o *GetParameterValueLongOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

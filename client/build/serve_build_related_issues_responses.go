...
func (o *ServeBuildRelatedIssuesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewServeBuildRelatedIssuesOK()
...
func NewServeBuildRelatedIssuesOK() *ServeBuildRelatedIssuesOK {
	return &ServeBuildRelatedIssuesOK{}
}
...
func (o *ServeBuildRelatedIssuesOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/builds/{buildLocator}/relatedIssues][%d] serveBuildRelatedIssuesOK  %+v", 200, o.Payload)
}

func (o *ServeBuildRelatedIssuesOK) GetPayload() *models.IssuesUsages {
	return o.Payload
}

func (o *ServeBuildRelatedIssuesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

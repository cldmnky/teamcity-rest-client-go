...
func (o *AddSnapshotDepOK) Error() string {
	return fmt.Sprintf("[POST /app/rest/buildTypes/{btLocator}/snapshot-dependencies][%d] addSnapshotDepOK  %+v", 200, o.Payload)
}
...
func (o *AddSnapshotDepOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

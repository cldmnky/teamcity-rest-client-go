...
func (o *ServersOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/federation/servers][%d] serversOK  %+v", 200, o.Payload)
}
...
func (o *ServersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *SetProjectAgentPoolsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSetProjectAgentPoolsOK()
...
func (o *SetProjectAgentPoolsOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/projects/{projectLocator}/agentPools][%d] setProjectAgentPoolsOK  %+v", 200, o.Payload)
}
...
func (o *SetProjectAgentPoolsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

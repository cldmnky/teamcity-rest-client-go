...
func (o *SetParentGroupsOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/userGroups/{groupLocator}/parent-groups][%d] setParentGroupsOK  %+v", 200, o.Payload)
}
...
func (o *SetParentGroupsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

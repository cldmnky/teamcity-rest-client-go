...
func (o *GetVcsRootEntryOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/buildTypes/{btLocator}/vcs-root-entries/{vcsRootLocator}][%d] getVcsRootEntryOK  %+v", 200, o.Payload)
}
...
func (o *GetVcsRootEntryOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

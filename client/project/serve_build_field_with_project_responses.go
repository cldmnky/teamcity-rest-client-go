...
func (o *ServeBuildFieldWithProjectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewServeBuildFieldWithProjectOK()
...
func NewServeBuildFieldWithProjectOK() *ServeBuildFieldWithProjectOK {
	return &ServeBuildFieldWithProjectOK{}
}
...
func (o *ServeBuildFieldWithProjectOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/projects/{projectLocator}/buildTypes/{btLocator}/builds/{buildLocator}/{field}][%d] serveBuildFieldWithProjectOK  %+v", 200, o.Payload)
}
...
func (o *ServeBuildFieldWithProjectOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

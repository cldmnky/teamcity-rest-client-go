...
func (o *SetParameterOK) Error() string {
	return fmt.Sprintf("[POST /app/rest/projects/{projectLocator}/projectFeatures/{featureLocator}/properties][%d] setParameterOK  %+v", 200, o.Payload)
}
...
func (o *SetParameterOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

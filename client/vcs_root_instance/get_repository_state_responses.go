...
func (o *GetRepositoryStateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetRepositoryStateOK()
...
func (o *GetRepositoryStateOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/vcs-root-instances/{vcsRootInstanceLocator}/repositoryState][%d] getRepositoryStateOK  %+v", 200, o.Payload)
}
...
func (o *GetRepositoryStateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

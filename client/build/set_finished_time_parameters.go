...
for the set finished time operation typically these are written to a http.Request
*/
...
func (o *SetFinishedTimeParams) WithBody(body string) *SetFinishedTimeParams {
	o.SetBody(body)
	return o
}

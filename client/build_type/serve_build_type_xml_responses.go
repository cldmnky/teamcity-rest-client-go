...
func (o *ServeBuildTypeXMLOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/buildTypes/{btLocator}][%d] serveBuildTypeXmlOK  %+v", 200, o.Payload)
}
...
func (o *ServeBuildTypeXMLOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

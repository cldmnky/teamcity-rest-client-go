...
func (o *GetEnvironmentVariablesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetEnvironmentVariablesOK()
...
func NewGetEnvironmentVariablesOK() *GetEnvironmentVariablesOK {
	return &GetEnvironmentVariablesOK{}
}
...
func (o *GetEnvironmentVariablesOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/debug/jvm/environmentVariables][%d] getEnvironmentVariablesOK  %+v", 200, o.Payload)
}
...
func (o *GetEnvironmentVariablesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

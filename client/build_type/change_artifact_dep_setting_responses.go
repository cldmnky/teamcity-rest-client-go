...
func (o *ChangeArtifactDepSettingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewChangeArtifactDepSettingOK()
...
func NewChangeArtifactDepSettingOK() *ChangeArtifactDepSettingOK {
	return &ChangeArtifactDepSettingOK{}
}
...
func (o *ChangeArtifactDepSettingOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/buildTypes/{btLocator}/artifact-dependencies/{artifactDepLocator}/{fieldName}][%d] changeArtifactDepSettingOK  %+v", 200, o.Payload)
}
...
func (o *ChangeArtifactDepSettingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

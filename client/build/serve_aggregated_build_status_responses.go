...
func (o *ServeAggregatedBuildStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewServeAggregatedBuildStatusOK()
...
func NewServeAggregatedBuildStatusOK() *ServeAggregatedBuildStatusOK {
	return &ServeAggregatedBuildStatusOK{}
}
...
func (o *ServeAggregatedBuildStatusOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/builds/aggregated/{buildLocator}/status][%d] serveAggregatedBuildStatusOK  %+v", 200, o.Payload)
}
...
func (o *ServeAggregatedBuildStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

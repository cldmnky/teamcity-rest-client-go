...
func (o *ServeBuildTypeTemplatesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewServeBuildTypeTemplatesOK()
...
func NewServeBuildTypeTemplatesOK() *ServeBuildTypeTemplatesOK {
	return &ServeBuildTypeTemplatesOK{}
}
...
func (o *ServeBuildTypeTemplatesOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/projects/{projectLocator}/templates/{btLocator}][%d] serveBuildTypeTemplatesOK  %+v", 200, o.Payload)
}
...
func (o *ServeBuildTypeTemplatesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

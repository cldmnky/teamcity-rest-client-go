...
func (o *UpdateVcsRootEntryCheckoutRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateVcsRootEntryCheckoutRulesOK()
...
func NewUpdateVcsRootEntryCheckoutRulesOK() *UpdateVcsRootEntryCheckoutRulesOK {
	return &UpdateVcsRootEntryCheckoutRulesOK{}
}
...
func (o *UpdateVcsRootEntryCheckoutRulesOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/buildTypes/{btLocator}/vcs-root-entries/{vcsRootLocator}/checkout-rules][%d] updateVcsRootEntryCheckoutRulesOK  %+v", 200, o.Payload)
}
...
func (o *UpdateVcsRootEntryCheckoutRulesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

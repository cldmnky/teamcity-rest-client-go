...
// WithScope adds the scope to the delete role params
func (o *DeleteRoleParams) WithScope(scope string) *DeleteRoleParams {
	o.SetScope(scope)
	return o
}

// SetScope adds the scope to the delete role params
func (o *DeleteRoleParams) SetScope(scope string) {
	o.Scope = scope
}

// WithUserLocator adds the userLocator to the delete role params
func (o *DeleteRoleParams) WithUserLocator(userLocator string) *DeleteRoleParams {
	o.SetUserLocator(userLocator)
	return o
}

// SetUserLocator adds the userLocator to the delete role params
func (o *DeleteRoleParams) SetUserLocator(userLocator string) {

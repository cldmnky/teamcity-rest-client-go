...
func (o *SetProjectFieldOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/projects/{projectLocator}/{field}][%d] setProjectFieldOK  %+v", 200, o.Payload)
}
...
func (o *SetProjectFieldOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

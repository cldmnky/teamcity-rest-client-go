...
func (o *QueueNewBuildOK) Error() string {
	return fmt.Sprintf("[POST /app/rest/buildQueue][%d] queueNewBuildOK  %+v", 200, o.Payload)
}
...
func (o *QueueNewBuildOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

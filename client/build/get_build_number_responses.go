...
func (o *GetBuildNumberOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/builds/{buildLocator}/number][%d] getBuildNumberOK  %+v", 200, o.Payload)
}
...
func (o *GetBuildNumberOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

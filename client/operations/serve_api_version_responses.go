...
func (o *ServeAPIVersionOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/apiVersion][%d] serveApiVersionOK  %+v", 200, o.Payload)
}
...
func (o *ServeAPIVersionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

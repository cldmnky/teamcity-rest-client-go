...
func (o *PutRequestDetailsOK) Error() string {
	return fmt.Sprintf("[PUT /app/rest/debug/currentRequest/details{extra}][%d] putRequestDetailsOK  %+v", 200, o.Payload)
}
...
func (o *PutRequestDetailsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

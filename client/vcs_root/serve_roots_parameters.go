...
// NewServeRootsParams creates a new ServeRootsParams object
// with the default values initialized.
func NewServeRootsParams() *ServeRootsParams {
	var ()
	return &ServeRootsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewServeRootsParamsWithTimeout creates a new ServeRootsParams object
...
// NewServeRootsParamsWithContext creates a new ServeRootsParams object
...
// NewServeRootsParamsWithHTTPClient creates a new ServeRootsParams object
...
/*ServeRootsParams contains all the parameters to send to the API endpoint
for the serve roots operation typically these are written to a http.Request
*/
type ServeRootsParams struct {

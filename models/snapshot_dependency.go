...
func (m *SnapshotDependency) validateProperties(formats strfmt.Registry) error {
...
func (m *SnapshotDependency) validateSourceBuildType(formats strfmt.Registry) error {

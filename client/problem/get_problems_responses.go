...
func (o *GetProblemsOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/problems][%d] getProblemsOK  %+v", 200, o.Payload)
}
...
func (o *GetProblemsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

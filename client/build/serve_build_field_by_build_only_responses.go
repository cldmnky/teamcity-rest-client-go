...
func (o *ServeBuildFieldByBuildOnlyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewServeBuildFieldByBuildOnlyOK()
...
func NewServeBuildFieldByBuildOnlyOK() *ServeBuildFieldByBuildOnlyOK {
	return &ServeBuildFieldByBuildOnlyOK{}
}
...
func (o *ServeBuildFieldByBuildOnlyOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/builds/{buildLocator}/{field}][%d] serveBuildFieldByBuildOnlyOK  %+v", 200, o.Payload)
}
...
func (o *ServeBuildFieldByBuildOnlyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

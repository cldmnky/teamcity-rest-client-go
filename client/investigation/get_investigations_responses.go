...
func (o *GetInvestigationsOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/investigations][%d] getInvestigationsOK  %+v", 200, o.Payload)
}
...
func (o *GetInvestigationsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

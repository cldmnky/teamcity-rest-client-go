...
func (o *ServeBranchesOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/buildTypes/{btLocator}/branches][%d] serveBranchesOK  %+v", 200, o.Payload)
}
...
func (o *ServeBranchesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

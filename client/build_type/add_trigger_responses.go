...
func (o *AddTriggerOK) Error() string {
	return fmt.Sprintf("[POST /app/rest/buildTypes/{btLocator}/triggers][%d] addTriggerOK  %+v", 200, o.Payload)
}
...
func (o *AddTriggerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

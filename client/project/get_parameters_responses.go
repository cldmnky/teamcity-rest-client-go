...
func (o *GetParametersOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/projects/{projectLocator}/projectFeatures/{featureLocator}/properties][%d] getParametersOK  %+v", 200, o.Payload)
}
...
func (o *GetParametersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *GetSnapshotDepOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/buildTypes/{btLocator}/snapshot-dependencies/{snapshotDepLocator}][%d] getSnapshotDepOK  %+v", 200, o.Payload)
}
...
func (o *GetSnapshotDepOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

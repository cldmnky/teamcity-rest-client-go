...
func (o *ServeBuildFieldOK) Error() string {
	return fmt.Sprintf("[GET /app/rest/buildTypes/{btLocator}/builds/{buildLocator}/{field}][%d] serveBuildFieldOK  %+v", 200, o.Payload)
}
...
func (o *ServeBuildFieldOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
